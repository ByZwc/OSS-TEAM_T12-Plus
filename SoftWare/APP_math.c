...
#define DISPLAY_FILTER_MIN_ALPHA 0.005f // 最小滤波系数
#define DISPLAY_FILTER_MAX_ALPHA 0.1f   // 最大滤波系数
#define DISPLAY_FILTER_MUM 6            // 阶数
#define RC_FILTER_DIFF_MAX 60.0f
#define RC_FILTER_DIFF_MIN 15.0f
