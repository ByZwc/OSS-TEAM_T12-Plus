...
#define DRIVE_BUTTON_GPIO_PIN       GPIO_PIN_12
...
#define DRIVE_BUTTON_RCC_ENABLE()   __HAL_RCC_GPIOA_CLK_ENABLE()

#define RES_ADC_SEL_GPIO_PORT      GPIOF
#define RES_ADC_SEL_GPIO_PIN       GPIO_PIN_2
#define RES_ADC_SEL_GPIO_PULL      GPIO_NOPULL
#define RES_ADC_SEL_GPIO_SPEED     GPIO_SPEED_FREQ_VERY_HIGH
#define RES_ADC_SEL_GPIO_MODE      GPIO_MODE_OUTPUT_PP
#define RES_ADC_SEL_RCC_ENABLE()   __HAL_RCC_GPIOF_CLK_ENABLE()
